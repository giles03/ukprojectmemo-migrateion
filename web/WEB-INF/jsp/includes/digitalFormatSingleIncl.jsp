...
%>
		...
		<table width="100%">
			<tr style='height: 1px'>
				<td style='width:10%; padding-right:1px; text-align:left;text-decoration: underline;'></td> 
					...
					if (iteratorDigiKeys.hasNext()) {
						...
						while (iteratorDigiVals.hasNext()) {
							while (iteratorDigiKeys.hasNext()) {
								...
								if((res3.getConfigurationId().equals("700")) ||(res3.getConfigurationId().equals("701")) || (res3.getConfigurationId().equals("711")) || (res3.getConfigurationId().equals("721"))){
