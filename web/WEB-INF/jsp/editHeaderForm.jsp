...
function grasPopupWarning(){

	
	var grasWarn   = document.getElementById('grasConfidentialProject');
	if (grasWarn.checked) {
	} else {
	alert("WARNING!\n Unchecking this will change all associated products to\n 'Gras Confidential = No' ");
	}
}
