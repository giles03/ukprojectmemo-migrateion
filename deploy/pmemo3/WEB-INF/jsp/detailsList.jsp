...
<%@page import="com.sonybmg.struts.pmemo3.model.*,
				...
				com.sonybmg.struts.pmemo3.db.ProjectMemoDAO"%>
 ...
 <div id="messageEditor" style="height: 100px;width: 400px;float:right; align:center;display:none;margin-bottom: 35px"> 
	...
	<fieldset style="border-top-style: none; border:thin solid #cccccc;width:100%">
		...
		<table width="100%">
			...
			<td style='width:31%; padding-right:2px; text-align:left;text-decoration: underline;'>
					Title
			</td>		
		...
		<tr>
			...
			<td style='text-align:center;padding-left:15px'>			
				<html:link action="/editPMHeader.do" name="headerParams">Edit Header</html:link>
	...
	<fieldset style="border: thin solid #cccccc;width:100%;">
		<legend style="text-decoration: underline;font-weight: bold;font-size: 16;">
			...
			<tr>
				...
				<td style='width:29%; padding-right:1px; text-align:left;text-decoration: underline;'>Product&nbsp;Title</td>
				...
				<td style='width:4%; text-align:left;text-decoration: underline;'>Excl?</td> 
				<td style='width:7%; text-align:left;text-decoration: underline;'>In GRPS?</td>
				<td style='width:13%;  text-align:left;text-decoration: underline;'>Product Format</td> 
				<td style='width:13%;  text-align:left;text-decoration: underline;'>Associated Physical</td>				
	...
	<%}%>
			...
			<td><%= (res3.getDigiScheduleInGRPS()) != null ? res3.getDigiScheduleInGRPS() : "&nbsp;"%></td>
			...
			<td>			
				<html:link action="/editPhysicalDraft.do" name="linkParams"><%= linkedFormat%></html:link>
			</td>		
				<% }else{%>
			<td>&nbsp;</td><%} %>	 
			<td><html:link action="/editDigitalDraft.do" name="paramsName">Edit</html:link></td>		
		...
		<tr>
			  	<td colspan="11" align=right style="padding-right:0px; padding-top: 10px"><html:link action="/addNewDigitalFormat.do" name="addParams"> Add New Format</html:link></td>
		</tr>	  	
				<%} else {%>
		<tr>
				<td colspan="7"></td> 
				<td colspan="4" align=right style="padding-right:30px;"><html:link action="/addNewDigitalFormat.do" name="addParams">Add New Format</html:link></td>
		</tr>
	...
	<fieldset style="border: thin solid #cccccc; width:100%;">
		<legend style="text-decoration: underline;font-weight: bold;font-size: 16">
			...
			<tr>
				...
				<td style='width:7%; text-align:left;text-decoration: underline;'>In GRPS?</td>
				<td style='width:13%;  text-align:left;text-decoration: underline;'>Product Format</td> 
				<td style='width:13%;  text-align:left;text-decoration: underline;'>Digital Equivalent</td>				
				<td style='width:8%;text-align:center;text-decoration: underline;' colspan=4> <b>Options</b> </td>
			</tr>
			...
			<%if (physicalDetails != null) {
				...
				if(digitalDetailId!=null){
					 ...
					 linkedFormat = fh.getSpecificFormat(linkedDigitalFormatID);
								...
								String modifiedPhysReleaseDate = dateFormat
										.format(stockReqDate);
	...
	<%}%>
				...
				<td> <%if (res.getCatalogNumber() != null) {%> 
				...
				<td><%= (res.getPhysScheduleInGRPS()) != null ? res.getPhysScheduleInGRPS() : "&nbsp;"%></td>							
				<td><%=format%> </td> 
			...
			<td><html:link action="/editDigitalDraft.do" name="linkParams"><%= linkedFormat%></html:link></td>	
				
			<% }else{%>
			
			<td>&nbsp;</td>
				 <%} %>
				<td><html:link action="/editPhysicalDraft.do" name="paramsName">Edit</html:link></td> 				
			...
			<tr>			
				<td colspan="11" align=right style="padding-right:0px; padding-top: 10px"><html:link action="/addNewPhysicalFormat.do" name="addParams"> Add New Format</html:link></td>
			</tr>					
				<% } else {%>
								
			<tr>
				<td colspan="7">&nbsp;</td> 
				<td colspan="3" align=right style="padding-right:30px;"><html:link action="/addNewPhysicalFormat.do" name="addParams"> Add New Format
				</html:link></td>
