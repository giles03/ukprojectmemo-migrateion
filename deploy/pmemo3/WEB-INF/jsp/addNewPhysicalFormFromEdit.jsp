	...
	div.outline
{
    ...
    <html:form method="POST" name="<%=formName%>" type="com.sonybmg.struts.pmemo3.form.PhysicalForm" action="/completeNewPhysicalFromEdit.do">
  	...
  	<table>
		<tr valign="top">
			<td>
				<span style='white-space: nowrap; font-size: 15; width: 150px;padding-right:15x'>TITLE<br />SUPPLEMENTAL<a onMouseover="ddrivetip('For Memo purposes only to help view/select individual products','#efefef', 155 )" onMouseout="hideddrivetip()">&nbsp;<img src="/pmemo3/images/info_red_smaller.jpg" border='0'></a></span>
				&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <table>
	<tr valign="top">
	    <td>			
			 <span style='white-space: nowrap; font-size: 14; padding-right:83px'><strong>FORMAT:</strong></span>
	    </td>
	    <td> 
	...
	<table width="50%">
     ...
     <tr>
	   <td>
    	 <span style='white-space: nowrap;font-size: 14'><strong>SCHEDULE ON GRPS?</strong></span>
  		</td>
  		<td>
