...
<body style="max-width:1250px;" onload="openEmailLink()">
	...
	<fieldset style="border: thin solid #E3E4FA;width:1050px;height: 95px;">
		...
		<%	if (prodAccess.equals("Y")) {%>
							...
							<span style='padding-right:2px; text-align:center;vertical-align: middle'>
									<a href="http://memo-test.smeukapps.com/css/?searchId=<%=pMemo.getMemoRef() %>&id=<%=user.getUserId()%>">CSS</a> 
							</span>
					 	<a href="http://memo-test.smeukapps.com/css/?searchId=<%=pMemo.getMemoRef() %>&id=<%=user.getUserId()%>">
					...
					%>
							...
							<span style='width:40px; padding-right:2px; padding-left:15px;text-align:left;vertical-align: middle'>
								...
								<html:link action="/listDetails.do" name="paramsName">				
		 						 <img src="/pmemo3/images/edit_button.jpg" border="0" align="bottom"/> 	
								</html:link> 
							</span>
