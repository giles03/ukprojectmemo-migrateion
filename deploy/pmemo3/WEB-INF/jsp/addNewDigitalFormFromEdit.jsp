	...
	<html:form method="POST" name="digitalForm" type="com.sonybmg.struts.pmemo3.form.DigitalForm" action="/completeNewDigitalFromEdit.do">
		<table style="table-layout: fixed">
			<tr valign="top">
				...
				<span style='white-space: nowrap; font-size: 15; width: 150px'>TITLE
					<a onMouseover="ddrivetip('For Memo purposes only to help view/select individual products','#efefef', 155 )" onMouseout="hideddrivetip()">&nbsp;<img src="/pmemo3/images/info_red_smaller.jpg" border='0'></a>
				</span>
			...
			<tr valign="top">
				<td style="min-width: 135px" colspan=2>
				<span style='white-space: nowrap; font-size: 15; width: 150px'>TITLE<br />SUPPLEMENTAL
					<a onMouseover="ddrivetip('For Memo purposes only to help view/select individual products','#efefef', 155 )" onMouseout="hideddrivetip()">&nbsp;<img src="/pmemo3/images/info_red_smaller.jpg" border='0'></a>
				</span>
			...
			<tr valign="top">									
			    			<% if(request.getAttribute("newDigiEquivRequired")!=null){				    				
				    					...
				    					<td><span style='white-space: nowrap; font-size: 15; min-width: 285px'><strong>FORMAT:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></span>
								...
								<%} else { %>
									...
									<html:select property="configurationId" styleId="configurationId" style="width:200px;" onchange="showHideCombo(); showHideGridNumber(); showOtherPopUp(); showAgeRating(); showVideoLength(); videoStreamDefaultChoice(); showHideVideoStreamingDate();">
										<html:option value=""></html:option>
			...
			<tr valign="top">
				<td>
						...
						<tr>
							...
							<td width="50px;">	
					    		 <span style='white-space: nowrap;font-size: 13'>GRAS CONFIDENTIAL?</span>	
					    	</td>
					    	<td>	 		 
						...
						<table width="100%">		
						<tr>
							<td><span style='white-space: nowrap; min-width: 295px; font-size: 15'id="relText"></span></td>
							<td><html:text property="releaseDate" size="17"
									style="background: #A9D0F5; text-align:center; plain:true" />
							...
							<%--<tr> 
								<td>
						    		<span style='white-space: nowrap;font-size: 15'>PRICE LINE:</span>
						    	</td>    	
						    	<td> 
							...
							<table width="100%">
							<tr>
								<td><span style='white-space: nowrap; min-width: 315px font-size: 15'>DEALER
										PRICE:&nbsp;&nbsp;&nbsp;</span></td>
				...
				<td>
					<table width="450px">
						<tr>
							...
							<% if(request.getAttribute("newDigiEquivRequired")!=null){%>	
								<fieldset
									style="padding-bottom: 5px; border: thin solid #cccccc; width: 105px">
									<span style='white-space: nowrap; width: 110px; font-size: 14'>&nbsp;VIDEO
										STREAM</span>
							...
							<td align="center">
								<fieldset
									style="padding-bottom: 5px; border: thin solid #cfcfcf; width: 245px">
									<span style='WORD-WRAP: break-word; font-size: 12;'>&nbsp;ALTERNATIVE
										AUDIO STREAM DATE</span>
					...
					<ul>
						<li>
							<div id="exclusiveDetails" class="outline"
								style='display: none; float: right; align: left'>
								<span style='white-space: nowrap; font-size: 12; padding-right: 47px'><b>EXCLUSIVE
										TO:</b> </span>
								<html:text property="exclusiveTo" maxlength="40" size="30"></html:text>
								...
								<html:text property="exclusivityDetails" maxlength="30"
									size="30"></html:text>
