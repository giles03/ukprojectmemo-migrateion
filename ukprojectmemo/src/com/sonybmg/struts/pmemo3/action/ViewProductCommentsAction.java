...
public class ViewProductCommentsAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		if(format.equals("digital")){		
			...
			prodCommentsList = (ArrayList) fh.getAllDigitalProductComments(memoRefAsString, detailIdAsString);
			prodHeader = (ArrayList) fh.getAllDigitalProductCommentHeader(memoRefAsString, detailIdAsString);
		
		} else {
			
			prodCommentsList = (ArrayList) fh.getAllPhysicalProductComments(memoRefAsString, detailIdAsString);	
