...
<div id="searchResultsBox">
	...
	<tr>
			...
			<%}%>			
			<td style='width:100px; padding-right:2px; text-align:center'>
			</td>
	...
	<%Iterator iterator = searchResults.iterator();
		...
		<tr>
			...
			<%			HashMap params = new HashMap();
						...
						if(res.getProductType().equals("D")){
							if((res.getConfigurationId().equals("715")) || (res.getConfigurationId().equals("719"))){
			...
			<a href="http://memo-test.smeukapps.com/css/?searchId=<%=res.getMemoRef() %>&id=<%=id%>&formatType=digital&detailId=<%=res.getDetailId()%>">
